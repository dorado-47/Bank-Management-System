...
class BankingSystem:
    def __init__(self, root):
        ...
        self.acc_num_label = tk.Label(self.create_account_frame, text="Account Number:",fg="blue")
        ...
        self.acc_holder_label = tk.Label(self.create_account_frame, text="Account Holder:",fg="blue")
        ...
        self.initial_balance_label = tk.Label(self.create_account_frame, text="Initial Balance:",fg="blue")
        ...
        self.create_acc_button = tk.Button(self.create_account_frame, text="Create Account", command=self.create_account,fg="blue")
        ...
        self.trans_acc_num_label = tk.Label(self.transaction_frame, text="Account Number:" ,fg="blue")
        ...
        self.amount_label = tk.Label(self.transaction_frame, text="Amount:",fg="blue")
        self.amount_label.grid(row=1, column=0)
        self.amount_entry = tk.Entry(self.transaction_frame)
        self.amount_entry.grid(row=1, column=1)

        self.deposit_button = tk.Button(self.transaction_frame, text="Deposit", command=self.deposit,fg="green")
        self.deposit_button.grid(row=2, column=0, pady=5)

        self.withdraw_button = tk.Button(self.transaction_frame, text="Withdraw", command=self.withdraw, fg="red")
        ...
        self.info_acc_num_label = tk.Label(self.info_frame, text="Account Number:",fg="blue")
        ...
        self.info_button = tk.Button(self.info_frame, text="Display Info", command=self.display_info,fg="blue",bg="black")
